...
public class Images {
    ...
    public static Image right_image = new Image("Images/right_button.png");
    public static Image menu_image = new Image("Images/menuimg.png");
    public static Image looptijd_image = new Image("Images/looptijd.png");
